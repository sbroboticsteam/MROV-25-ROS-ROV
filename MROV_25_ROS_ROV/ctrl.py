...
class ControllerSubscriber(Node):
    ...
    def __init__(self):
        ...
        self.get_logger().info("Controller subscriber + thruster publisher ready")
    ...
    def cb(self, msg: String):
        ...
        vertical = data['lt'] - data['rt']

        if self.mode:
            thrusters = thruster_mix(
                data['left_y'],
                data['left_x'],
                vertical,
                data['right_x'],
        ...
        out_msg.data = thrusters.astype(float).tolist()
